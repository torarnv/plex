...
public:
  ...
  void GuiCharsetTo(const CStdStringA& strDestCharset, CStdStringA& strSourceDest);

  void GuiCharsetTo(const CStdStringA& strDestCharset, const CStdStringA& strSource, CStdStringA& strDest);
