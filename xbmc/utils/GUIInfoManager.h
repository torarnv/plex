...
#define LISTITEM_STAR_DIFFUSE       (LISTITEM_START + 44)
#define LISTITEM_BANNER             (LISTITEM_START + 45)
#define LISTITEM_FIRST_GENRE        (LISTITEM_START + 46)
