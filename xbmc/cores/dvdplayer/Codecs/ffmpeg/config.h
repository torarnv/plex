...
#define FFMPEG_CONFIGURATION "--extra-cflags=-D_XBOX --enable-postproc --enable-gpl --enable-static --disable-vhook --enable-swscale --enable-protocol=http --disable-altivec --disable-ipv6 --enable-pthreads --disable-debug --disable-shared"
